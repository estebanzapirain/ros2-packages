...
#include "map_interface/msg/detail/block__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = map_interface::msg::Block;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const map_interface::msg::Block *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<map_interface::msg::Block *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_map_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<map_interface::msg::Block>()
{
  return &map_interface::msg::typesupport_fastrtps_cpp::_Block__handle;
}
