...
#include "robot_pos_interface/msg/detail/robot_position__rosidl_typesupport_fastrtps_c.h"
...
#include "robot_pos_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _RobotPosition__ros_msg_type = robot_pos_interface__msg__RobotPosition;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_pos_interface
size_t get_serialized_size_robot_pos_interface__msg__RobotPosition(
  const void * untyped_ros_message,
...
static uint32_t _RobotPosition__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_pos_interface__msg__RobotPosition(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_pos_interface
size_t max_serialized_size_robot_pos_interface__msg__RobotPosition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_pos_interface__msg__RobotPosition;
    is_plain =
      (
...
static size_t _RobotPosition__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_pos_interface__msg__RobotPosition(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_pos_interface, msg, RobotPosition)() {
